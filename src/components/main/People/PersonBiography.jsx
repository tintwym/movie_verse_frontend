          ...
          <div className="view">
            ...
            <div className="view__wrapper">
              <div className="view__poster">
                {actor?.id ? (
                  <LazyLoad debounce={false} height={450} offsetVertical={500} width={300}>
                    <ImageLoader alt={actor.name} imgId={actor.id} src={`${tmdbPosterPath + actor.profile_path}`} />
                  </LazyLoad>
                ) : (
              ...
              <div className="view__details">
                ...
                <p className="view__overview">
                  {actor?.id ? (
                    actor.biography || <span style={{ fontStyle: 'italic', opacity: '.7' }}>Biography not found</span>
                  ) : (
                    <Skeleton count={4} />
                  )}
                </p>
                ...
                <div className="view__actions">
                  {actor?.id && (
                    <>
                      ...
                      &nbsp;
                      <button className="button--outlined" onClick={onClickLink}>
                        View Photos &nbsp;&nbsp;
