...
export function DesktopNavbar() {
  ...
  return (
    <header
      className={cn(
        "sticky top-0 z-50 hidden border-b bg-[#050510]/80 backdrop-blur-xl transition-all duration-300 lg:block",
        scrolled
    ...
    >
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-4 px-8">
        <Link href="/" className="group flex items-center gap-2 font-bold text-white">
          <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-indigo-500 to-violet-600 transition-transform duration-300 group-hover:scale-105">
        ...
        <form onSubmit={handleSearch} className="flex flex-1 max-w-md">
          <div className="relative w-full">
            ...
            <input
              ...
              className="w-full rounded-xl border border-white/10 bg-white/5 py-2 pl-10 pr-4 text-sm text-white placeholder:text-zinc-500 outline-none focus:border-indigo-500/50"
            />
          </div>
        </form>
          ...
          {isLoggedIn ? (
            <div className="relative" ref={menuRef}>
              <button
                ...
                className="flex items-center gap-2 rounded-xl border border-white/10 bg-white/5 px-3 py-2 text-sm text-white transition hover:bg-white/10"
              >
